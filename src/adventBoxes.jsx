const adventBoxes = [
      ...
      },
    {
      ...
      },
     {
      ...
      {
        number: 17,
        img: '/public/czechitas-advent-images/17.jpg',
        text: "Najdi na obrázku dárek s mašlí.",
        open: false
      },
      {
        number: 18,
        img: '/public/czechitas-advent-images/18.jpg',
        text: "V Betlémě se narodil...",
        open: false
      },
      {
        number: 19,
        img: '/public/czechitas-advent-images/19.jpg',
        text: "Když zlobíme čert nám donese...",
        open: false
      },
      {
        number: 20,
        img: '/public/czechitas-advent-images/20.jpg',
        text: "Jaká zvířátka táhnou Santovi saně?",
        open: false
      },
      {
        number: 21,
        img: '/public/czechitas-advent-images/21.jpg',
        text: "V Americe nosí dárky někdo jiný než ježíšek, kdo to je?",
        open: false
      },
      {
        number: 22,
        img: '/public/czechitas-advent-images/22.jpg',
        text: "Kdo pomáhá Santovi a Ježíškovi balit vánoční dárky?",
        open: false
      },
      {
        number: 23,
        img: '/public/czechitas-advent-images/23.jpg',
        text: "Která země má jako první Štědrý den?",
        open: false
      },
      {
        number: 24,
        img: '/public/czechitas-advent-images/24.jpg',
